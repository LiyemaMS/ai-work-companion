...
function Disclaimer(){return <p className="mt-4 border-t border-border pt-4 text-xs leading-5 text-muted-foreground">AI-generated content may contain errors or omissions. Review and verify important information before using it. You remain responsible for final decisions and workplace communications.</p>}
